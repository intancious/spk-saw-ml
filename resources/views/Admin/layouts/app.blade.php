...
<head>
    ...
    <title>{{ $title ?? 'Home' }} - SPK</title>

    <!-- Custom fonts for this template-->
    <link href="{{ asset('template/backend') }}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css">
    <link
    ...
    <link href="{{ asset('template/backend') }}/css/datepicker3.css" rel="stylesheet">
    <link href="{{ asset('template/backend') }}/css/sb-admin-2.min.css" rel="stylesheet">
    <link href="{{ asset('template/backend') }}/css/mlbb-theme.css" rel="stylesheet">
    ...
    <script src="{{ asset('template/backend') }}/js/demo/bootstrap-datepicker.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#sidebarToggle").click(function(e) {
                e.preventDefault();
                $("body").toggleClass("sidebar-toggled"); // Toggle body class
                $(".sidebar").toggleClass("toggled"); // Toggle sidebar class
            });

            // Optional: Handle resizing and ensure proper toggling on larger screens
